...
const FirstTab = () => {
    ...
    const { data, loading, endReached, page } = useSelector((state) => state.tiketReducer);

    const path = '/api/tiket-wisma/datatable?entries=10&user_mitra_id=' + appGaoUserLogin.user_mitra.id;
